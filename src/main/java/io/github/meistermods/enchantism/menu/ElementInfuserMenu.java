...
public final class ElementInfuserMenu extends AbstractContainerMenu {
  ...
  public ElementInfuserMenu(int containerId, Inventory inventory, FriendlyByteBuf buffer) {
    this(
        containerId,
        inventory,
  ...
  public ElementInfuserMenu(
      int containerId,
      Inventory inventory,
      ElementInfuserBlockEntity blockEntity,
      ContainerData data) {
  ...
  private ElementInfuserMenu(
    ...
    super(ModMenus.ELEMENT_INFUSER.get(), containerId);
  ...
  private void addMachineSlots() {
     ...
     */
    this.addSlot(
        new Slot(this.container, ElementInfuserBlockEntity.MATERIAL_SLOT, 56, 35) {
          @Override
     ...
     */
    this.addSlot(
        new Slot(this.container, ElementInfuserBlockEntity.CONTAINER_SLOT, 116, 35) {
          @Override
          public boolean mayPlace(ItemStack stack) {

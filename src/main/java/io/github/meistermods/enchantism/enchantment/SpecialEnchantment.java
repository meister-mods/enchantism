 ...
 * - are excluded from the vanilla enchanting table;
 * - are excluded from villager enchanted-book trades;
 * - cannot normally be stored on enchanted books;
 * - define which material activates them in the special enchanting table.
 */
public abstract class SpecialEnchantment extends Enchantment
{
    ...
    /**
     * Prevents this enchantment from being selected by the vanilla
     * enchanting-table algorithm and other normal random-enchantment sources.
     */
    @Override
     ...
     *
     * Remove this override later if special enchanted books should be supported.
     */
    @Override
    ...
    /**
     * Returns whether the supplied material can generate this enchantment
     * at the special enchanting table.
     */

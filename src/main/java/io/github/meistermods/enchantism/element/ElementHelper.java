...
{
    private static final Map<Item, ElementMaterialData> MATERIALS =
            new HashMap<>();
    ...
    public static ElementMaterialData getMaterialData(
    ...
    )
    {
        ...
        {
            return new ElementMaterialData(
                    ElementType.STONE,
                    90
            );
        }
    ...
    {
        ElementMaterialData data =
                getMaterialData(stack);
    ...
    public static boolean isValidMaterial(
            @Nonnull ItemStack stack
    )
    {
